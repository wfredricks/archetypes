...
// Q: What human-readable name should the BookendAuditAgent emit in its
//    `agentName` field? Mirrors `@adopt:agent-name-completeness` in
...
// Q: Same default-namespace marker as completeness-agent.ts.
// Default: asi
