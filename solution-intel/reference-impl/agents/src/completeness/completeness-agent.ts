 ...
 *   (Phase 2.5 canonical refresh; tag `solution-intel-reference-impl-2026-05-22d`)
 *   from wfredricks/archetypes-solution-intelligence/agents
 *   @ commit cc6bc8687ee61e17994a65e2f7be92d065155a8f.
 *
...
//    Operators override per-run via `--namespace` or `<NS>_NAMESPACE`.
