 ...
 *   from wfredricks/archetypes-solution-intelligence/scripts/query-events-spine.ts
...
// @adopt:default-graph-url / @adopt:default-graph-user / @adopt:default-graph-pass  Inline replacement; adopter prefers env-var form.
