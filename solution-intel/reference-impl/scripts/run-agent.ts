 ...
 *   from wfredricks/archetypes-solution-intelligence/scripts/run-agent.ts
...
function parseFlags(argv: string[]): Flags {
  const out: Flags = {
    // @adopt:default-namespace  Replace 'asi' with the adopter's namespace; ASI_ prefix is the adopter's env-var prefix.
    namespace: process.env.ASI_NAMESPACE ?? '@adopt:default-namespace',
