 ...
 *   from wfredricks/archetypes-solution-intelligence/scripts/verify-graph.ts
  ...
  try {
    ...
    try {
      const res = await session.run(
        ...
        // @adopt:default-namespace  Replace 'asi' with the adopter's namespace tag.
        { adoptionId: '@adopt:default-namespace' },
      );
